...
/**
 * Created by woavm on 2018-05-31.
 */

public class Interestbook extends AppCompatActivity { //관심도서 클래스
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://ipAddress/GetInterestBookData.php?userID="+Login.userIdKey+"&order="+order;

        Log.d("url",url);
        final String[] mid = {"정렬조건","평점순","제목순"};
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 1:
                        Intent intent1 = new Intent(getApplicationContext(), Interestbook.class);
                        intent1.putExtra("order","star");
                        startActivity(intent1);
                        finish();
                        break;
                    case 2:
                        Intent intent2 = new Intent(getApplicationContext(), Interestbook.class);
    ...
    protected void showList(){
        ...
        ArrayList<InterestBookInfo> interebookInfoArrayList = new ArrayList<>(); //관심도서 InterestBookInfo 생성
        try{
            ...
            for(int i =0;i<books.length();i++){
                ...
                try {
                    mThread.join();
                    interebookInfoArrayList.add(new InterestBookInfo(bm,title,star));
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
            InterestBook_Adapter myAdapter = new InterestBook_Adapter(interebookInfoArrayList);
        ...
        class GetDataJSON extends AsyncTask<String, Void, String>{
            ...
            protected String doInBackground(String... strings) { //Strings는 url을 담고있는 배열
                ...
                try{
                    ...
                    String json;
                    //String sb에 버퍼로 읽어온 url의 문장들을 저장해줌
